...
export default function SectionBlock({ section, onRename, onRemove, onSplit, onUpdateItem, onRemoveItem, onReorderItems, inventory, dragHandleProps }) {
  ...
  const isIndirectsSection = normalizeDesc(section.title) === 'indirects total' || normalizeDesc(section.title) === 'directs total' || normalizeDesc(section.title) === 'support and logistics';
